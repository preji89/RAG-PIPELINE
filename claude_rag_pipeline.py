...
from openai import OpenAI  # Claude API has no embeddings endpoint; kept for embeddings only
...
class ClaudeRAGPipeline:
    ...
    def query(self, question: str, top_k: int = 3) -> str:
        """RAG query: retrieve context, then generate an answer with Claude."""
